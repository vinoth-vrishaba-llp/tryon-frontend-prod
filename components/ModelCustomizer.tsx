       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <OptionSelectorRow
          ...
          <div>
            ...
            {/* Additional Info for Basic Plan Users */}
            {user && user.planType === 'Basic' && (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-bold text-amber-800 mb-1">
                      Basic Plan: Standard Quality Only
                    </p>
                    <p className="text-xs text-amber-700">
                      Upgrade to Pro or Ultimate to unlock High (2K) and Ultra (4K) quality rendering with enhanced details and textures.
                    </p>
                  </div>
                </div>
              </div>
