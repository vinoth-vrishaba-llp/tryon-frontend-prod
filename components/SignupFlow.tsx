...
const SignupFlow: React.FC<SignupFlowProps> = ({ onSignupSuccess, onNavigateToLogin }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-md w-full rounded-2xl bg-white backdrop-blur-xl shadow-2xl border border-white/30 p-6 sm:p-8 z-10">
        {/* Header */}
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-sm font-medium ${step >= 2 ? 'text-indigo-600' : 'text-primary'}`}>
              Set Password
            </span>
          </div>
          ...
          <form onSubmit={handleStepOneSubmit} className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:outline-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 bg-primary text-white font-bold rounded-lg shadow-lg hover:bg-indigo-800 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:scale-100 flex justify-center items-center"
            >
              {loading ? (
          ...
          <form onSubmit={handleStepTwoSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-16 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:outline-none"
                minLength={8}
              />
              <button
                type="button"
            ...
            <div className="flex space-x-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-3 px-4 bg-primary text-white font-bold rounded-lg shadow-lg hover:bg-indigo-800 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:scale-100 flex justify-center items-center"
              >
                {loading ? (
                  <div className="h-5 w-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                ) : (
